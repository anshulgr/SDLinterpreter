...
{-callFrustum ang up right direction = do
                                      sz<-get screenSize
                                      ...
                                      let near= 0.004
                                         ...
                                         -- x1 = right1
                                          ...
                                          --  right =  top*aspect
                                      frustum (-right) (right) (-height) height near far --(-top) top near far
                                      matrixMode $= Modelview 0
-}


callFrustum ang1 up right direction  = do
                     sz<-get screenSize
                     viewport $= ((Position 0 0), sz)
                     matrixMode $= Projection
                     loadIdentity
                     let near= 0.9--0.004
                       ...
                       --  aspect = (w)/(h)
                       --  right = top*aspect
                     --perspective = ang1 (right/top) near far
